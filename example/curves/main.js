...
function generatePosition() {
    for (var i = 0; i < lineCount; i++) {
        stage.add(new Curve({
            points: [random$1(10, canvas.width - 10), random$1(10, canvas.height - 10), random$1(10, canvas.width - 10), random$1(10, canvas.height - 10), random$1(10, canvas.width - 10), random$1(10, canvas.height - 10), random$1(10, canvas.width - 10), random$1(10, canvas.height - 10)],
            color: randomColor$1(),
